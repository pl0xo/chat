<?php
//Чат пишется в файл chat.db - это по сути обычный html-файл и там можно подправить все, что надо, открыв его обычным текстовым редактором. Либо вообще удалить этот файл - тогда чат пересоздаст его и будет полностью чист.

//Чтобы выводить ip адрес, нужно вместо этой строки
...
//добавить эту, здесь добавлено <span class="id">(' . $id . ')</span> 
